...
#function to update device as undefined
    def update_undefined(self, DeviceView, Device):
        ...
        DeviceView.Widget = UndefinedProgress(source=undefined_picture,size=(self.width/6,self.height/5),allow_stretch=False,size_hint=(None,None), angle=self.angle)
...
#function ot update device as added
    def update_added(self, DeviceView, Device):
        DeviceView.Widget = Label(size=(self.width/6,self.height/5),size_hint=(None,None), font_size=16, color=(0, 0, 0, 1),
